                    ...
                    <!--    <a href="" class = "navbar-brand"><img id="logo" src="logo.png"></a> -->
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a href="SHSyear.php" class="nav-link hovers"><i class='fa fa-home' style='font-size:15px;color:#015baa;margin: 4px'></i>Home</a>
                                </li>
...
<div style="height: 500px; width: 100%; background-image: linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.7)), url(img/background1.jpg); background-repeat: no-repeat; background-position: center; background-size: cover;">
...
<!-- div class="container">
    <div class="row">
        ...
        <!--  <p><strong>Welcome </strong><?php //echo  $_SESSION['GetUser']; ?></p> -->
            <?php if($rtnYear) { ?>
            <form action="SHSvotingsection.php" method="GET" role="form">
                <div class="form-group">
                    <!-- <label for="year">School Year</label> -->
                    <select required class="form-control" name="year" hidden >
               ...
               <?php 
                    ...
                    if(mysqli_num_rows($res) == ""){?>
                        <div class="md-form">
                        <input type="submit" name="submit" value="Voting is not yet begun" class="btns">
                      </div>
                    <?php } else {?>
                ...
                ?>
                 <div class="md-form">
                <button type="submit" name="submit" value="Go to voting section  " class="btns">Go to voting section</button><br><br>
               </div>
                <?php } else{ ?>
