...
<?php
    ...
    <!--  <a href="print.php?schoolyear=<?php echo $schoolyear; ?>"><h3><span class="fas fa-print " style="float: right"></h3></span>  </a> -->
                <h4 style="text-align: center;"> SSC Voting Result for Tertiary <br> School Year: <?php echo $schoolyear; ?></h4><div id="refresh"><p style="text-align: center;">as of <?php date_default_timezone_set('Asia/Manila'); echo date('F j, Y g:i:sa'); ?>  </p></div>   
