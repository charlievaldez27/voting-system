...
//for graph
  $query ="SELECT vStatus, count(*) as number from status where Status = 'Enrolled' and Level = 'Senior High' and schoolyear = '$schoolyear' or schoolyear is NULL group by vStatus";
...
<head>
    ...
    <script type="application/javascript">
        ...
        $('#showtest').load('shs.result-auto-current.php');
         },1000);
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'SSC Voting for Senior High Percentage:',
          is3D:true
        };
    ...
    <div class="row">
       ...
       foreach($results as $output)
        ...
        <div class="col-md-9" id="showtest" >
                <?php include('shs.result-auto-current.php'); ?>
