<?php
     include("class/CurrentResult.php");
     ...
     <a href="print.php?schoolyear=<?php echo $schoolyear; ?>"><h3><span class="fas fa-print " style="float: right"></h3></span></a>
      ...
      if($schoolyear == 'null'):
        ...
        <?php else: ?>
                ...
                <h4> SSC Voting Result for Tertiary (<?php echo $schoolyear; ?>)</h4><div id="refresh"><p>as of <?php date_default_timezone_set('Asia/Manila'); echo date('F j, Y g:i:sa');    ?>  </p></div>   
