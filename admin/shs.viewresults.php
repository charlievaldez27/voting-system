...
require("../includes/pdo.php");
                $sql = "SELECT schoolyear from tbl_schoolyear where Status = 'Ended' order by id desc";
...
<head>
    ...
    <script type="application/javascript">
        ...
        $('#showtest').load('shs.result-auto.php');
         },1000);
    ...
    <div class="row">
            ...
            <h3>Select School Year</h3>
             <hr style="background: #ffc107;height: 2px;">
                ...
                <div class="form-group">
                    ...
                    <select name="schoolyear" class="form-control" id="syList"  >
       ...
       foreach($results as $output)
        ...
        <div class="col-md-9" id="showtest" >
                <?php include('shs.result-auto.php'); ?>
